...
@Controller
public class EigoController extends CommonMainController {

	@Autowired
	private EigoService eigoService;

	// 英語モードを表す文字列
	private final String MODE_STR ="eigo";
	 ...
	 */
	@Override
	protected EigoService getService() {

		return this.eigoService;
	}
	 ...
	 * @param grade URLの/eigo/の後に続く文字列
	 * @return HTMLファイル名
	 */
