...
@Controller
public class JukugoController extends CommonMainController {

	@Autowired
	private JukugoService jukugoService;

	// 漢字モードを表す文字列
	private final String MODE_STR ="jukugo";
	 ...
	 */
	@Override
	protected JukugoService getService() {

		return this.jukugoService;
	}
